...
public class Q4 extends GraphicsProgram {
	...
	public void run() {
		...
		for(int i=0;i<NUM_ROWS;i++) {
			for(int j=0;j<NUM_ROWS;j++) {
				...
				if((j<NUM_ROWS/2 &&i==0) || (i==NUM_ROWS/2 || j==NUM_ROWS/2)
						||(i>NUM_ROWS/2 && j==0) || j==NUM_ROWS-1 && i<NUM_ROWS/2 || (j>NUM_ROWS/2&&i==NUM_ROWS-1)) {
